...
urlpatterns = [
    ...
    path("list/", contentviews.all_task, name="list"),
    ...
    path("list/<slug:date>/<int:slot>/delete/", contentviews.task_delete, name="delete"),
    path("list/<slug:date>/<int:slot>/edit/", contentviews.task_edit, name="edit"),
